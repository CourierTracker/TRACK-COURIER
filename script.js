...
/* Active step */
.tracking-steps li.show {
opacity: 1;
font-weight: bold;
}

/* In Transit step */
.tracking-steps li.In Transit {
...
/* Soft Growing Background - Full Page /
html, body {
margin: 0;
padding: 0;
height: 100%; / Ensure body and html cover full page */
background: linear-gradient(135deg, #a1c4fd 0%, #b3d9fc 50%, #c2e9fb 100%);
...
header {
display: flex;
align-items: center;        / vertical centering of logo and text /
justify-content: space-between; / space between logo/text and nav buttons /
width: 100%;
padding: 10px 20px;
...
content: "";
position: fixed;
top: 50px; / move it down from top /
left: 20%;
width: 300px;   / airplane size */
height: 200px;
...
@keyframes flyPlane {
0% { left: -300px; top: 80px; }
100% { left: 100%; top: 60px; }
}
...
width: 600px;
height: 400px;
background: url('ship.png') no-repeat center bottom;
background-size: contain;
opacity: 0.8;
z-index: -1;
pointer-events: none;
...
/* Make the plane float/move horizontally /
#movingPlane {
position: absolute;
